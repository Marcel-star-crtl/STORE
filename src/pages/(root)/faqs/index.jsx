...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-black py-4">
      ...
      {isOpen && (
        <div className="mt-2">
          <p style={{ fontFamily: "Poppins-Regular", fontSize: "14px" }} dangerouslySetInnerHTML={{ __html: answer }} />
        </div>
      )}
    </div>
  );
  ...
  useEffect(() => {
    const fetchFAQs = async () => {
      ...
      try {
        ...
        console.log("Success fetching FAQs:", data);

        // Assuming the response is directly an array of FAQs
