...
const Invoice = ({ order }) => {
  ...
  const { userDetails, products, totalAmount, createdAt, orderStatus, paymentIntent, shortId } = order;
    ...
    <div className="receipt-container p-4 sm:p-6 lg:p-8">
      <div className="header flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        <div>
          ...
          <p className="text-lg">#{shortId || 'N/A'}</p>
        </div>
      ...
      <div className="order-items mt-8">
        ...
        {products && products.map((item, index) => (
          <div key={item.product._id || index} className="order-item mb-4 flex flex-col sm:flex-row items-start">
            <Image
