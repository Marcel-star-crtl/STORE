                    ...
                    >
                      ...
                      <div className="flex gap-4 items-center">
                        <div className="flex flex-col justify-between items-end h-full">
                          <button
                            className="hover:text-red-1 cursor-pointer bg-transparent border-none mb-auto"
                          ...
                          <p className="text-small-medium bold-text" style={{fontSize: "18px", fontWeight: "600"}}>
